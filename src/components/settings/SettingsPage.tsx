    ...
    <div className="space-y-4">
      <section className="space-y-2">
        ...
        <p className="text-[12px] leading-relaxed text-ink-soft">
          ...
          is the brain. A skill is the written method that agent should follow (how to write a proposal,
          triage inbox, run a weekly report). Assign a department or agent ids so the right person gets it.
          You can also add <code className="text-ink">skills/&lt;name&gt;/SKILL.md</code> folders on GitHub
          and they will ship with the next deploy.
        </p>
        {skills.map((s) => (
